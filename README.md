...
![alt text](<../Pertemuan 15/gambar/scrip 1 tabel perusahaan.png>)
...
![alt text](<../Pertemuan 15/gambar/scrip 2 tabel departemen.png>)
...
![alt text](<../Pertemuan 15/gambar/sciprt tabel karyawan.png>)
...
![alt text](<../Pertemuan 15/gambar/script tabel project.png>)
...
![alt text](<../Pertemuan 15/gambar/script project detail.png>)
...
```sql
SELECT nik, nama, id_dept FROM Karyawan WHERE id_dept = (SELECT id_dept FROM Karyawan WHERE nama = 'Delfyno');
```

**Output :**

![alt text](<../Pertemuan 15/gambar/script 1.png>)
...
![alt text](<../Pertemuan 15/gambar/script 2.png>)
...
![alt text](<../Pertemuan 15/gambar/script 3.png>)
...
![alt text](<../Pertemuan 15/gambar/SCRIPT 4.png>)
...
![alt text](<../Pertemuan 15/gambar/script 5.png>)
